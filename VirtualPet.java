public class VirtualPet {
    ...
    public void whipHim(Whip whip){
   if (getWeight() > 150){
     this.weight -= whip.getWeightDecr();
     this.happiness -= whip.getHappinessDecr();
   }
  }
  
  public void Lipo(Liposuction liposuction){
    if (getWeight() > 150){
      this.weight = liposuction.getOriginalWeight();
    }
  }
